...
do
    train -c -m $MODEL -pd segmentation_from_gt -4D -bs 32 -ne 4 -lr 0.0001 -po segmentation_from_gt
...
MODEL=efficientnet
train -c -m $MODEL -pd segmentation_from_gt -4D -bs 8 -ne 4 -lr 0.00005 -po segmentation_from_gt
